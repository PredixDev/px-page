...
function runBaseTests() {
  px_page_1 = document.getElementById('px_page_1');

  suite('Base Automation Tests for px-page', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-page fixture is created', function() {
      assert.isTrue(document.getElementById('px_page_1') !== null);
    });
